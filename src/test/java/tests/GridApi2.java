...
public class GridApi2 extends BaseTest {

    int formId = 34089;
    String requestId = "7289049067";
    String controlId = "110084";

    UIUtil ui;

 // ===== BASIC =====
    
    String expectedCaptiontext = "mehta "; 
    String expectedDefaultValue = "ANKITtttttt";
    String expectedEnabled = "Y";
    String expectedVisibility = "Y";

    // ===== CAPTION FONT =====
    String expectedCaptionFontSize = "21";
    String expectedCaptionFontStyle = "Underline";
    String expectedCaptionFontColor = "#ffffff";
    String expectedCaptionFontFace = "Arial";
    String expectedCaptionBackgroundColor = "#123abc";
