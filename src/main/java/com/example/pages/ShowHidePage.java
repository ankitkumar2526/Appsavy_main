	...
	private final Page page ;
	  ...
	  public ShowHidePage(Page page)
	 {
	  ...
	  public void verifyShowLabelOnTyping(String inputText) {
		  ...
		  Locator showTextBox = page.locator("#ctrl109616");   // your textbox
		  Locator showLabel = page.locator("#lblCap109614");   // your label
	      ...
	      boolean isVisible = showLabel.isVisible();

	      Assert.assertTrue(isVisible, "FAILED: Show label is not visible after typing");
